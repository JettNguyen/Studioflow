import type { ProjectDetails, ProjectSummary, SongWorkspace } from '@studioflow/shared';
...
export const demoProjectDetails: ProjectDetails[] = [
  {
    id: 'proj-1',
    title: 'Neon Skyline EP',
...
export const demoSongWorkspace: SongWorkspace[] = [
  {
    id: 'song-1',
    title: 'Afterglow',
    key: 'D Minor',
